...
* Ввод ответа текстом, а не кнопкой
* API-слой для внешних клиентов (например, мобильного приложения)
* Веб-панель статистики (FastAPI + фронт)

---

Если хочешь — могу:

✨ подготовить красивую версию с эмодзи и иллюстрациями
✨ собрать PDF-документацию
✨ сгенерировать диаграммы (Mermaid) для README
